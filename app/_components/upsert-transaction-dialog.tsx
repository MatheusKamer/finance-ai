...
import { upsertTransaction } from "../_actions/upsert-transacion";
...
export function UpsertTransationDialog({
  isOpen,
  transactionId,
  defaultValues,
  setIsOpen,
  ...
  const isUpdated = Boolean(transactionId);
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>
            {isUpdated ? "Editar Transação" : "Adicionar Transação"}
          </DialogTitle>

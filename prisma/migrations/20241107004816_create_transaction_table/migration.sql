...
-- CreateEnum
CREATE TYPE "TransactionPaymentMethod" AS ENUM ('CASH', 'CREDIT_CARD', 'DEBIT_CARD', 'BANK_TRANSFER', 'PAYPAL', 'VENMO', 'CASH_APP', 'ZELLE', 'APPLE_PAY', 'GOOGLE_PAY', 'BITCOIN', 'ETHEREUM', 'LITECOIN', 'DOGECOIN', 'SHIBA_INU', 'SAFEMOON', 'OTHER');
